...
/**
 * A programmatic right for Book Publishing feature.
 *
 * @version $Id$
 * @since 0.1
 */
@Unstable
public final class PublishBookRight implements RightDescription
{
    /**
     * Singleton instance for a Book Publishing right.
     */
    public static final PublishBookRight INSTANCE = new PublishBookRight();

    private PublishBookRight()
    {
